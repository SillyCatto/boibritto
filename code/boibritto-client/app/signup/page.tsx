...
const GENRES = [
  "fiction", "non-fiction", "fantasy", "sci-fi", "mystery", "romance", "thriller", "historical", 
  "biography", "poetry", "self-help", "horror", "drama", "adventure", "comedy", "spirituality", 
  "philosophy", "science", "psychology", "children", "classic", "graphic-novel", 
  "memoir", "education", "others"
];
      ...
      <div className="max-w-xl w-full mx-auto px-8 py-14 bg-white rounded-2xl shadow-lg relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-sm mx-auto">Tell us about yourself to personalize your reading experience</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">This will be your unique identifier on BoiBritto</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
              />
              <p className="mt-1 text-xs text-gray-500">Optional, max 500 characters</p>
            </div>

            {/* Genre dropdown */}
            <div ref={dropdownRef}>
              <label className="block text-gray-700 font-medium mb-2">
                Interested Genres <span className="text-sm font-normal text-gray-500">(Select up to 5)</span>
              </label>
              
              {/* Selected genres display */}
              <div className="flex flex-wrap gap-2 mb-2">
                {genres.length === 0 && (
                  <div className="text-gray-400 text-sm">No genres selected</div>
                )}
                
                {genres.map((genre) => (
                  <div key={genre} className="bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-sm flex items-center">
                    {formatGenre(genre)}
                    <button 
                      type="button"
              ...
              >
                <span className="text-gray-700">
                  {genres.length === 5 ? "Maximum genres selected" : "Select genres"}
                </span>
                <svg 
                  ...
                  <div className="p-2 grid grid-cols-2 gap-1">
                    {GENRES.map((genre) => {
                      ...
                      return (
                        ...
                        >
                          <span className={`w-4 h-4 mr-2 flex-shrink-0 rounded border ${
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">
              ...
              <Link href="/signin" className="text-amber-700 font-medium hover:text-amber-800 hover:underline">
                Sign in
              </Link>
            </p>
          </div>
